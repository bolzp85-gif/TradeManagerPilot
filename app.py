...
# ============================================================
st.set_page_config(
    page_title="Trade Manager & Decision Cockpit v3.2 Fused",
    page_icon="🛡️",
    layout="wide"
)

st.title("🛡️ Trade Manager & Decision Cockpit v3.2 Fused")
st.caption(
    "Systematisches Decision-Gate – aktuelle Market-Regime-Engine + "
    "MTF + Dual-Limit Sizing (Risiko vs. Margin) + Was-wäre-wenn-Analyse"
)
st.markdown("---")

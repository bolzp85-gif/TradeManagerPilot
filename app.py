...
# ============================================================
st.set_page_config(
    page_title="Trade Manager & Decision Cockpit v2.6",
    page_icon="🛡️",
    layout="wide"
)

st.title("🛡️ Trade Manager & Decision Cockpit v2.6")
st.caption(
...
with col_setup:
    ...
    if product_type == "Futures":
        ...
        fut_comm_rt_native = st.number_input(
            ...
            min_value=0.0,
            value=float(spec["default_comm_roundturn"]),
            step=0.5,
            help=(
        ...
        spread_points = st.number_input(
            ...
            min_value=0.0,
            value=float(spec["default_spread"]),
            step=0.1,
            help=(
        ...
        daily_overnight_pct = st.number_input(
            ...
            min_value=0.0,
            value=float(spec["default_overnight_pct"]),
            step=0.005,
            format="%.3f",
            help=(
...
total_score = max(
    0.0,
    trend_points + sent_points - penalties
)
...
def calculate_position_dual(
    ...
    # Wichtig:
    # act_stop_risk enthält NUR das Stop-Loss-Risiko.
    act_stop_risk = (
        units
        * stop_cost_per_unit
    )
...
if (
    ...
    if micro_key_found:
        ...
        # Proportionale Kommissionsskalierung
...
# Netto-Risiko = Stop + sämtliche Kosten
net_risk_eur = (
    stop_loss_risk_eur
    + total_costs_eur
)
...
# Netto-Reward = Brutto-Reward - Kosten
net_reward_eur = max(
    0.0,
    actual_reward_eur
    - total_costs_eur
...
# ============================================================
# 23. TRANSPARENTER RISIKO-BREAKDOWN
# ============================================================
...
st.caption(
    "Hinweis: v2.6 Cockpit ist ein rein quantitatives "

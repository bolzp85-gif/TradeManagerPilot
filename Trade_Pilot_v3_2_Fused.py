...
# ============================================================
st.set_page_config(
    page_title="Trade Manager & Decision Cockpit v3.5.1 Fused",
    page_icon="🛡️",
    layout="wide"
)

st.title("🛡️ Trade Manager & Decision Cockpit v3.5.1 Fused")
st.caption(
...
if blocking_events:
    ...
    st.info(
        "ℹ️ Im aktuell geladenen offiziellen Kalender wurde "
        "für die nächsten 7 Tage kein passendes High-Impact-Event gefunden."
    )
...
with st.expander(
    ...
    st.caption(
        ...
        "US-Makrotermine (BLS/BEA/Fed); bei Öl zusätzlich EIA; "
